...
open('../../PythonStudy/test.txt', mode='w', encoding='utf-8')

#write a file
wf = open('../../PythonStudy/test.txt', 'w', encoding='utf-8')
wf.write('Tom\n')
wf.writelines(['Hello\n', 'Python'])
